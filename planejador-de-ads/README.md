...
description: Painel de saúde das suas campanhas de Mercado Ads com score, 7 verificações, gamificação e tarefas diárias.
audience: vendedores
...
![Tela do Planejador de Ads Beta mostrando score de Saúde dos Ads com nível Bronze, XP, sequência, histórico e tarefas](../assets/screenshots/planejador-ads-v1.png)
...
![Tela expandida da Saúde dos Ads mostrando as 7 verificações com pontuação e sugestões](../assets/screenshots/saude-detalhes-v1.png)
